...
#    Updated: 2023/06/07 17:06:14 by zvan-de-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_FILES		= so_long.c player.c init.c map_pars.c error.c map_checks.c fill_map.c load_png.c flood_fill.c moves.c enemy.c animations.c\
